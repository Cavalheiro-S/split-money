                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap items-center gap-2 text-sm text-gray-600">
                                ...
                                {transaction.payment_status && (
                                    <Badge 
                                        variant={transaction.payment_status.description === "Pago" ? "default" : "secondary"}
                                        className="text-xs"
                                    >
                    ...
                    <div className="flex flex-col items-end gap-2">
                        ...
                        <div className="flex items-center gap-1">
                            <Button
                                ...
                                title={transaction.is_virtual ? "Transações virtuais não podem ser editadas" : "Editar transação"}
                            >
                            ...
                            <DeleteTransactionConfirmationModal
                                ...
                                trigger={
                                    <Button
                                        ...
                                        title={transaction.is_virtual ? "Transações virtuais não podem ser excluídas" : "Excluir transação"}
                                    >
